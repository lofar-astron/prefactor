...
########################################################################
def main(h5parmdb, refh5parm = '/data/solutions/3C48.h5', insolset='sol000', outsolset='sol000', insoltab='amplitude000', outsoltab='amplitude000', antenna = '[FUSPID].*', trusted_sources = '3C48,3C147,3C196,3C295,3C380', parset = None, max_separation_arcmin = 1.0, do_transfer = True):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--trusted', type=str, default='3C48,3C147,3C196,3C295,3C380',
