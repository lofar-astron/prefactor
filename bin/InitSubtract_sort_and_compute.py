...
def main(ms_input, outmapname=None, mapfile_dir=None, cellsize_highres_deg=0.00208, cellsize_lowres_deg=0.00694,
    ...
    for band in bands:
        ...
        imsize_high_res_stretch = int(imsize_high_res*y_axis_stretch)
        ...
        imsize_high_pad_stret = int(imsize_high_res*image_padding*y_axis_stretch)
        high_paddedsize_map.append(DataProduct('localhost', str(imsize_high_pad)+" "+str(imsize_high_pad_stret), False))
        imsize_low_pad = int(imsize_low_res*image_padding)
        imsize_low_padded_stretch = int(imsize_low_res*image_padding*y_axis_stretch)
        low_paddedsize_map.append(DataProduct('localhost', str(imsize_low_pad)+" "+str(imsize_low_pad_stret), False))
